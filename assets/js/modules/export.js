	...
	var bexport = {
        ...
        init: function() {
            ...
            $('#publishBtn').on('click', function() {
                $.post("_export.php", $("#markupForm").serialize(), function(data) {
       ...
       */
        prepExport: function(e) {
            ...
            $('#pageList > ul').each(function(){
                ...
                var siteName = GetQueryStringParams('site-name');

                var siteNameInput = $('<input type="hidden" name="site-name"  value="' + siteName + '">');
                $('#exportModal form').prepend( siteNameInput );
